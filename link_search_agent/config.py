"""Configuration classes for Link Search Agent training and evaluation."""
...
class GRPOConfig(BaseModel):
    ...
    # Model settings - using ModelScope Qwen3-32B
    ...
    # Agent settings
    max_turns: int = 15  # Link search may need more turns
    max_tokens: int = 4096
    max_profiles: int = 10  # Target number of profiles to find
...
class PolicyConfig(BaseModel):
    """Policy configuration for the link search agent."""
